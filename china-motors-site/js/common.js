(() => {
  ...
  const translations = {
    ru: {
      ...
      kp_download: 'СКАЧАТЬ PDF', kp_share: 'ПОДЕЛИТЬСЯ',
    ...
    kk: {
      ...
      kp_download: 'PDF ЖҮКТЕП АЛУ', kp_share: 'БӨЛІСУ',
    ...
    zh: {
      ...
      kp_download: '下载 PDF', kp_share: '分享',
    ...
    en: {
      ...
      kp_download: 'DOWNLOAD PDF', kp_share: 'SHARE',
